...
items.push({ 'titulo': 'METABÓLITOS SECUNDÁRIOS - TERPENOS', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
...
items.push({ 'titulo': 'COMPOSTOS FENÓLICOS', 'nome': 'Aula 24', 'arquivo': '24.html', 'identificador': '23' });


items.push({ 'titulo': 'COMPOSTOS FENÓLICOS - FLAVONOIDES', 'nome': 'Aula 25', 'arquivo': '25.html', 'identificador': '24' });
items.push({ 'titulo': 'COMPOSTOS FENÓLICOS - TANINOS', 'nome': 'Aula 26', 'arquivo': '26.html', 'identificador': '25' });
...
items.push({ 'titulo': 'COMPOSTOS NITROGENADOS - ALCALOIDES', 'nome': 'Aula 31', 'arquivo': '31.html', 'identificador': '31' });
...
items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS', 'nome': 'Aula 36', 'arquivo': '36.html', 'identificador': '36' });
...
items.push({ 'titulo': 'DIALOGUE COM A PRÁTICA', 'nome': 'Aula 41', 'arquivo': '41.html', 'identificador': '41' });
