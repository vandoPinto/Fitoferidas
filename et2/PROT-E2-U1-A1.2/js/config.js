...
var nomeAula = "Aula 1.2 - Plantas Medicinais e Fitoterápicos - Conceitos Básicos";


items.push({ 'titulo': 'AGRADECIMENTOS ESPECIAIS', 'nome': 'Aula 1', 'arquivo': '1.html', 'identificador': '0' });
items.push({ 'titulo': 'OBJETIVOS', 'nome': 'Aula 2', 'arquivo': '2.html', 'identificador': '1' });
items.push({ 'titulo': 'PRÉ-REQUISITOS', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
items.push({ 'titulo': 'BOAS-VINDAS', 'nome': 'Aula 4', 'arquivo': '4.html', 'identificador': '3' });
items.push({ 'titulo': 'BREVE HISTÓRICO DA FITOTERAPIA COMO RECURSO TERAPÊUTICO', 'nome': 'Aula 5', 'arquivo': '5.html', 'identificador': '4' });
items.push({ 'titulo': '', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': 'CONCEITOS BÁSICOS DE PLANTAS MEDICINAIS E FITOTERÁPICOS', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': '', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'TERMOS TÉCNICOS/CONCEITOS REFERENTES À FITOTERAPIA', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
...
items.push({ 'titulo': 'PLANTAS MEDICINAIS E FITOTERÁPICOS NO TRATAMENTO DE FERIDAS', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });

items.push({ 'titulo': '', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
items.push({ 'titulo': 'IDENTIFICAÇÃO BOTÂNICA DAS PLANTAS MEDICINAIS', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });
...
items.push({ 'titulo': 'NOME POPULAR E NOME CIENTÍFICO: A IDENTIDADE DAS PLANTAS MEDICINAIS', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '18' });
items.push({ 'titulo': 'NOME CIENTÍFICO: A IDENTIDADE DAS PLANTAS MEDICINAIS', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '19' });
...
items.push({ 'titulo': 'IMPORTANTE!', 'nome': 'Aula 23', 'arquivo': '23.html', 'identificador': '22' });
