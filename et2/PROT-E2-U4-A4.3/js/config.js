...
items.push({ 'titulo': 'AS QUATRO ORGANIZAÇÕES DO SER HUMANO (QUADRIMEMBRAÇÃO)', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
...
items.push({ 'titulo': 'OS TRÊS SISTEMAS FUNCIONAIS (TRIMEMBRAÇÃO)', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });

items.push({ 'titulo': '', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });


items.push({ 'titulo': 'ABORDAGEM DAS FERIDAS', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });
...
items.push({ 'titulo': 'ABORDAGEM DE FERIDAS SEGUNDO FATORES PREDISPONENTES PARA A SUA FORMAÇÃO', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '17' });
...
items.push({ 'titulo': 'RECURSOS TERAPÊUTICOS LOCAIS UTILIZADOS PELA ANTROPOSOFIA, DE ACORDO COM AS FASES DO TRATAMENTO', 'nome': 'Aula 27', 'arquivo': '27.html', 'identificador': '26' });

items.push({ 'titulo': '', 'nome': 'Aula 28', 'arquivo': '28.html', 'identificador': '27' });
items.push({ 'titulo': 'SÍNTESE DO TRATAMENTO DAS FERIDAS NA VISÃO DA ANTROPOSOFIA APLICADA À SAÚDE', 'nome': 'Aula 29', 'arquivo': '29.html', 'identificador': '28' });
items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS', 'nome': 'Aula 30', 'arquivo': '30.html', 'identificador': '30' });
items.push({ 'titulo': 'AVALIAÇÃO', 'nome': 'Aula 31', 'arquivo': '31.html', 'identificador': '31' });
items.push({ 'titulo': 'REFERÊNCIAS BIBLIOGRÁFICAS', 'nome': 'Aula 32', 'arquivo': '32.html', 'identificador': '32' });
/*
