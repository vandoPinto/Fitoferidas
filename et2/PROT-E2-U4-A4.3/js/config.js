...
items.push({ 'titulo': 'BOAS-VINDAS', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
items.push({ 'titulo': '', 'nome': 'Aula 4', 'arquivo': '4.html', 'identificador': '3' });
items.push({ 'titulo': 'LINHA DO TEMPO DA ANTROPOSOFIA APLICADA À SAÚDE', 'nome': 'Aula 5', 'arquivo': '5.html', 'identificador': '4' });
items.push({ 'titulo': 'INTRODUÇÃO', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': '', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': '', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'AS QUATRO ORGANIZAÇÕES DO SER HUMANO (QUADRIMEMBRAÇÃO)', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
...
items.push({ 'titulo': 'OS TRÊS SISTEMAS FUNCIONAIS (TRIMEMBRAÇÃO)', 'nome': 'Aula 12', 'arquivo': '12.html', 'identificador': '11' });
items.push({ 'titulo': '', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });

items.push({ 'titulo': 'ABORDAGEM DAS FERIDAS', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
...
items.push({ 'titulo': 'ABORDAGEM DE FERIDAS SEGUNDO FATORES PREDISPONENTES PARA A SUA FORMAÇÃO', 'nome': 'Aula 17', 'arquivo': '17.html', 'identificador': '16' });


items.push({ 'titulo': '', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '17' });

items.push({ 'titulo': 'FERIDAS POR INSUFICIÊNCIA ARTERIAL', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '18' });
items.push({ 'titulo': '', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '19' });
items.push({ 'titulo': 'FERIDAS POR DECÚBITO', 'nome': 'Aula 21', 'arquivo': '21.html', 'identificador': '20' });
items.push({ 'titulo': '', 'nome': 'Aula 22', 'arquivo': '22.html', 'identificador': '21' });
items.push({ 'titulo': 'FERIDAS EM DIABÉTICOS', 'nome': 'Aula 23', 'arquivo': '23.html', 'identificador': '22' });

items.push({ 'titulo': '', 'nome': 'Aula 24', 'arquivo': '24.html', 'identificador': '23' });


items.push({ 'titulo': 'RECURSOS TERAPÊUTICOS LOCAIS UTILIZADOS PELA ANTROPOSOFIA, DE ACORDO COM AS FASES DO TRATAMENTO', 'nome': 'Aula 25', 'arquivo': '25.html', 'identificador': '24' });
items.push({ 'titulo': '', 'nome': 'Aula 26', 'arquivo': '26.html', 'identificador': '25' });
items.push({ 'titulo': 'SÍNTESE DO TRATAMENTO DAS FERIDAS NA VISÃO DA ANTROPOSOFIA APLICADA À SAÚDE', 'nome': 'Aula 27', 'arquivo': '27.html', 'identificador': '26' });

items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS', 'nome': 'Aula 28', 'arquivo': '28.html', 'identificador': '27' });
items.push({ 'titulo': 'AVALIAÇÃO', 'nome': 'Aula 29', 'arquivo': '29.html', 'identificador': '28' });
items.push({ 'titulo': 'REFERÊNCIAS BIBLIOGRÁFICAS', 'nome': 'Aula 30', 'arquivo': '30.html', 'identificador': '30' });
/*
...
items.push({ 'titulo': '', 'nome': 'Aula 42', 'arquivo': '42.html', 'identificador': '42'});
