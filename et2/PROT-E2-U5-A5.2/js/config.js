...
items.push({ 'titulo': 'FARMÁCIA VIVA NO SUS: BETIM-MG', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'O PROGRAMA FARMÁCIAS VIVAS DE FORTALEZA - CE', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
items.push({ 'titulo': 'A EXPERIÊNCIA EM IGREJINHA - RS', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
items.push({ 'titulo': 'A FARMÁCIA VIVA DA SECRETARIA DE ESTADO DE SAÚDE DO DF', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });

items.push({ 'titulo': 'O CASO DA UNIFAP/MACAPÁ – AP', 'nome': 'Aula 12', 'arquivo': '12.html', 'identificador': '11' });
items.push({ 'titulo': 'FARMÁCIA DA NATUREZA – INTEGRAÇÃO SERVIÇO E ESCOLA', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });

items.push({ 'titulo': 'A EXPERIÊNCIA DE SÃO BENTO DO SUL – SC', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });


items.push({ 'titulo': 'A FARMÁCIA VIVA E APLICAÇÃO DE FITOTERÁPICOS NO TRATAMENTO DE FERIDAS NO MUNICÍPIO DE BREJO DA MADRE DE DEUS - PE', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });

items.push({ 'titulo': 'A EXPERIÊNCIA DO MUNICÍPIO DE TOLEDO COM PLANTAS MEDICINAIS E FITOTERÁPICOS', 'nome': 'Aula 16', 'arquivo': '16.html', 'identificador': '15' });

items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS', 'nome': 'Aula 17', 'arquivo': '17.html', 'identificador': '16' });
