...
var nomeUnidade = "Unidade 3 - Plantas Medicinais com Potencialidades para o Tratamento de Feridas";
var nomeAula = "Aula 3.1 - Plantas Medicinais e Fitoterápicos - Ampliação do Cuidado no Tratamento de Feridas";
...
items.push({ 'titulo': 'A FITOTERAPIA COMO MÉTODO TERAPÊUTICO', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': '', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': 'APLICAÇÃO DE PLANTAS MEDICINAIS E FITOTERÁPICOS', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
...
items.push({ 'titulo': 'REFERÊNCIAS', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '16' });
items.push({ 'titulo': '', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '17' });
items.push({ 'titulo': '', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '18' });
