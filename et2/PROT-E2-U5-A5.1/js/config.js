...
var nomeAula = "Aula 5.1 - Implantação e Organização da Fitoterapia no SUS";
...
items.push({ 'titulo': 'POLÍTICAS PÚBLICAS, PROGRAMAS E PROJETOS', 'nome': 'Aula 5', 'arquivo': '5.html', 'identificador': '4' });
items.push({ 'titulo': '', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': 'A FITOTERAPIA NOS ESTADOS E MUNICÍPIOS', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': '', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'A FITOTERAPIA NO SUS - PROGRAMA DE PESQUISAS DE PLANTAS MEDICINAIS DA CENTRAL DE MEDICAMENTOS', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
items.push({ 'titulo': 'A INSERÇÃO DA FITOTERAPIA NOS MUNICÍPIOS', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
items.push({ 'titulo': 'A FARMACOPÉIA BRASILEIRA', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });
...
items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });
...
items.push({ 'titulo': 'REFERÊNCIAS', 'nome': 'Aula 22', 'arquivo': '22.html', 'identificador': '21' });
