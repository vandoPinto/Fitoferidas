...
var nomeAula = "Aula 4.1 - Termalismo Social e Crenoterapia";
...
items.push({ 'titulo': 'HISTÓRIA DO TERMALISMO NO BRASIL', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': '', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': '', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'HISTÓRIA DO TERMALISMO EM ÁGUAS DE LINDÓIA', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
...
items.push({ 'titulo': 'AMBULATÓRIO DE FERIDAS - BALNEÁRIO MUNICIPAL', 'nome': 'Aula 12', 'arquivo': '12.html', 'identificador': '11' });
...
items.push({ 'titulo': 'RELATOS DE CASOS', 'nome': 'Aula 16', 'arquivo': '16.html', 'identificador': '15' });
...
items.push({ 'titulo': 'FLUXO DO SERVIÇO E NÚMERO DE USUÁRIOS ATENDIDOS', 'nome': 'Aula 21', 'arquivo': '21.html', 'identificador': '20' });
items.push({ 'titulo': 'DESCRIÇÃO DOS SERVIÇOS', 'nome': 'Aula 22', 'arquivo': '22.html', 'identificador': '21' });
items.push({ 'titulo': '', 'nome': 'Aula 23', 'arquivo': '23.html', 'identificador': '22' });

items.push({ 'titulo': 'PLANTAS MEDICINAIS E FITOTERÁPICOS E TERMALISMO', 'nome': 'Aula 24', 'arquivo': '24.html', 'identificador': '23' });
...
items.push({ 'titulo': 'AVALIAÇÃO', 'nome': 'Aula 27', 'arquivo': '27.html', 'identificador': '26' });

items.push({ 'titulo': 'REFERÊNCIAS BIBLIOGRÁFICAS', 'nome': 'Aula 28', 'arquivo': '28.html', 'identificador': '27' });
