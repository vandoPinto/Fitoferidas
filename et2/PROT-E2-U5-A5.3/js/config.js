...
var nomeAula = "Aula 5.3 - Aspectos legais do exercício profissional em relação a prescrição de plantas medicinais e fitoterápicos";
...
items.push({ 'titulo': 'CONSELHOS FEDERAIS DE CLASSE PROFISSIONAL', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': '', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': 'CATEGORIAS PROFISSIONAIS', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
...
items.push({ 'titulo': 'CONSIDERAÇÕES FINAIS DO CURSO', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });


items.push({ 'titulo': '', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });

items.push({ 'titulo': 'REFERÊNCIAS BIBLIOGRÁFICAS', 'nome': 'Aula 16', 'arquivo': '16.html', 'identificador': '15' });
