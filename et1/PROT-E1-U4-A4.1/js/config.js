...
var nomeUnidade = "Unidade 4 - Fundamentos e Conceitos no Tratamento de Feridas";
var nomeAula = "Aula 4.1 - Aspectos Nutricionais Relacionados ao Tratamento de Feridas";
...
items.push({ 'titulo': 'A PRESERVAÇÃO DO ESTADO NUTRICIONAL', 'nome': 'Aula 4', 'arquivo': '4.html', 'identificador': '3' });
items.push({ 'titulo': '', 'nome': 'Aula 5', 'arquivo': '5.html', 'identificador': '4' });
items.push({ 'titulo': '', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': 'APORTE DE PROTEÍNA', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': '', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'OXIDAÇÃO', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
...
items.push({ 'titulo': 'VITAMINA C (ÁCIDO ASCÓRBICO)', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });
items.push({ 'titulo': '', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
items.push({ 'titulo': 'VITAMINA E (ALFA TOCOFEROL)', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });
items.push({ 'titulo': 'ZINCO', 'nome': 'Aula 16', 'arquivo': '16.html', 'identificador': '15' });
items.push({ 'titulo': '', 'nome': 'Aula 17', 'arquivo': '17.html', 'identificador': '16' });


items.push({ 'titulo': 'PLANTAS MEDICINAIS QUE ESTIMULAM AS ENZIMAS ANTIOXIDANTES:', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '17' });
...
items.push({ 'titulo': 'GLICAÇÃO', 'nome': 'Aula 22', 'arquivo': '22.html', 'identificador': '21' });
...
items.push({ 'titulo': 'DIALOGUE COM A PRÁTIDCA', 'nome': 'Aula 28', 'arquivo': '28.html', 'identificador': '27' });
items.push({ 'titulo': 'REFERÊNCIAS', 'nome': 'Aula 29', 'arquivo': '29.html', 'identificador': '28' });
