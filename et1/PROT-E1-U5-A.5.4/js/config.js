...
var nomeAula = "Aula 5.4 - Lesão por Pressão";
...
items.push({ 'titulo': 'LESÃO POR PRESSÃO - LP', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
...
items.push({ 'titulo': 'MEDIDAS DE PREVENÇÃO DA LESÃO POR PRESSÃO', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': '', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
items.push({ 'titulo': 'CATEGORIZAÇÃO E TRATAMENTO DA LESÃO POR PRESSÃO', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
items.push({ 'titulo': 'TRATAMENTO DA LESÃO POR PRESSÃO', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });
...
items.push({ 'titulo': 'LESÃO POR PRESSÃO – ESTÁGIO 1', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
items.push({ 'titulo': 'LESÃO POR PRESSÃO – ESTÁGIO 2', 'nome': 'Aula 15', 'arquivo': '15.html', 'identificador': '14' });

items.push({ 'titulo': 'LESÃO POR PRESSÃO – ESTÁGIO 3', 'nome': 'Aula 16', 'arquivo': '16.html', 'identificador': '15' });
items.push({ 'titulo': 'LESÃO POR PRESSÃO – ESTÁGIO 4', 'nome': 'Aula 17', 'arquivo': '17.html', 'identificador': '16' });


items.push({ 'titulo': 'LESÃO POR PRESSÃO NÃO CLASSIFICÁVEL', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '17' });
items.push({ 'titulo': 'LESÃO POR PRESSÃO TISSULAR PROFUNDA', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '18' });
items.push({ 'titulo': 'LESÃO POR PRESSÃO EM MEMBRANAS MUCOSAS', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '19' });
items.push({ 'titulo': 'LESÃO POR PRESSÃO RELACIONADA A DISPOSITIVOS MÉDICOS', 'nome': 'Aula 21', 'arquivo': '21.html', 'identificador': '20' });
items.push({ 'titulo': 'AVALIAÇÃO', 'nome': 'Aula 22', 'arquivo': '22.html', 'identificador': '21' });
items.push({ 'titulo': 'REFERÊNCIAS', 'nome': 'Aula 23', 'arquivo': '23.html', 'identificador': '22' });
/*
