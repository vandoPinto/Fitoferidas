...
var nomeAula = "Aula 5.5 - Lesões Relacionadas a Adesivos Médicos - MARSI";
...
items.push({ 'titulo': 'MARSI – LESÕES RELACIONADAS A ADESIVOS MÉDICOS', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
items.push({ 'titulo': '', 'nome': 'Aula 4', 'arquivo': '4.html', 'identificador': '3' });
items.push({ 'titulo': 'MARSI – CLASSIFICAÇÃO MECÂNICA', 'nome': 'Aula 5', 'arquivo': '5.html', 'identificador': '4' });
items.push({ 'titulo': 'MARSI – FATORES DE RISCO', 'nome': 'Aula 6', 'arquivo': '6.html', 'identificador': '5' });
items.push({ 'titulo': 'MARSI CLASSIFICAÇÃO: MACERAÇÃO', 'nome': 'Aula 7', 'arquivo': '7.html', 'identificador': '6' });
items.push({ 'titulo': 'MARSI CLASSIFICAÇÃO: FOLICULITE', 'nome': 'Aula 8', 'arquivo': '8.html', 'identificador': '7' });
items.push({ 'titulo': 'MARSI CLASSIFICAÇÃO: DERMATITE DE CONTATO', 'nome': 'Aula 9', 'arquivo': '9.html', 'identificador': '8' });
items.push({ 'titulo': 'MARSI CLASSIFICAÇÃO: DERMATITE ALÉRGICA', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
items.push({ 'titulo': 'TRATAMENTO DA MARSI', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });
