...
var nomeAula = "Aula 3.7 - Infecção em Feridas Agudas e Crônicas";
...
items.push({ 'titulo': 'INFECÇÃO EM FERIDAS AGUDAS E CRÔNICAS', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
...
items.push({ 'titulo': 'SINAIS DE INFECÇÃO EM FERIDAS AGUDAS', 'nome': 'Aula 10', 'arquivo': '10.html', 'identificador': '9' });
items.push({ 'titulo': '', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });
items.push({ 'titulo': 'SINAIS DE INFECÇÃO EM FERIDAS CRÔNICAS', 'nome': 'Aula 12', 'arquivo': '12.html', 'identificador': '11' });
items.push({ 'titulo': '', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });
items.push({ 'titulo': 'O QUE PRECISAMOS SABER SOBRE COLETA DE EXAMES MICROBIOLÓGICOS EM FERIDAS?', 'nome': 'Aula 14', 'arquivo': '14.html', 'identificador': '13' });
...
items.push({ 'titulo': 'TERAPIA TÓPICA PARA FERIDAS INFECTADAS', 'nome': 'Aula 17', 'arquivo': '17.html', 'identificador': '16' });
items.push({ 'titulo': '', 'nome': 'Aula 18', 'arquivo': '18.html', 'identificador': '17' });
items.push({ 'titulo': 'PLANTAS MEDICINAIS E FITOTERÁPICOS', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '18' });
items.push({ 'titulo': '', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '19' });
items.push({ 'titulo': 'AVALIAÇÃO', 'nome': 'Aula 21', 'arquivo': '21.html', 'identificador': '20' });
