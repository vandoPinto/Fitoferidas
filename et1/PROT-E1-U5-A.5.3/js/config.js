...
var nomeAula = "Aula 5.3 - Úlceras Venosas";
...
items.push({ 'titulo': 'ÚLCERAS VENOSAS', 'nome': 'Aula 3', 'arquivo': '3.html', 'identificador': '2' });
...
items.push({ 'titulo': 'BOAS PRÁTICAS COM A ÚLCERA VENOSA E A PELE PERILESIONAL', 'nome': 'Aula 11', 'arquivo': '11.html', 'identificador': '10' });
items.push({ 'titulo': '', 'nome': 'Aula 12', 'arquivo': '12.html', 'identificador': '11' });
items.push({ 'titulo': 'ÚLCERAS VENOSAS – CONSIDERAÇÕES TERAPÊUTICAS', 'nome': 'Aula 13', 'arquivo': '13.html', 'identificador': '12' });
...
items.push({ 'titulo': 'ALGORITMO DE TRATAMENTO DA ÚLCERA VENOSA', 'nome': 'Aula 19', 'arquivo': '19.html', 'identificador': '18' });
items.push({ 'titulo': 'CARACTERÍSTICAS DIFERENCIAIS DAS ÚLCERAS ARTERIAIS E VENOSAS', 'nome': 'Aula 20', 'arquivo': '20.html', 'identificador': '19' });
items.push({ 'titulo': 'ÍNDICE TORNOZELO-BRAQUIAL - ITB', 'nome': 'Aula 21', 'arquivo': '21.html', 'identificador': '20' });
